...
import com.farnadsoft.onlineshop.feature.auth.AuthActivity
import io.reactivex.disposables.CompositeDisposable
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe
import org.greenrobot.eventbus.ThreadMode

abstract class ShopFragment : Fragment(), ShopView {
...
abstract class ShopActivity : AppCompatActivity(), ShopView {
    override val rootView: CoordinatorLayout?
        get() {
...
interface ShopView {
    ...
    fun showError(nikeException: Exception) {
        viewContext?.let {
            when (nikeException.type) {
                Exception.Type.SIMPLE -> showSnackBar(
